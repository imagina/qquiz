<template>
  <div>
    ...
    <div v-if="success">
      ...
      <crud-form :questionIdh="questionId" v-model="showModal" v-if="(params.create || params.update) && showModal"
...
<script>
  //Component
  import crudIndex from '@imagina/qquiz/_components/admin/answers/index'
  import crudForm from '@imagina/qquiz/_components/admin/answers/form'
