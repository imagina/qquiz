<template>
  <div id="componentCrudIndex" class="questionComponent">
    <!--Content-->
      ...
      <div class="relative-position col-12" v-if="success">
        ...
        >
          ...
          <q-td slot="body-cell-actions" slot-scope="props" :props="props">
            ...
            <!-- Button NEW -->   
            <q-btn size="sm" class="q-ml-xs"
                   icon="fas fa-boxes" color="deep-orange">
                <q-tooltip :delay="300">{{$tr('qquiz.layout.pluralAnswer)}}</q-tooltip>
            </q-btn>
